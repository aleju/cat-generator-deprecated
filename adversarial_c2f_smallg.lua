...
function adversarial.train(trainData)
    ...
    for t = 1,N_epoch,dataBatchSize do 
        ...
        for k=1, OPT.D_iterations do
            ...
            local generatedImages = sampleFromSmallerGs(realDataSize/2)
            for i = 1, realDataSize/2 do
                condInputs[inputIdx] = generatedImages[i]:clone()
                inputIdx = inputIdx + 1
            end
            
            -- add generated diffs to sampled data
        ...
        for k=1, OPT.G_iterations do
            ...
            local inputIdx = 1
            local generatedImages = sampleFromSmallerGs(thisBatchSize/2)
